...
const toggleButtonVisibility = (buttonId) => {
 ...
 let stateStoreInstance = computed(() => stateStore);
</script>
                ...
                >
                  <router-link class="flex-shrink-0" to="/">
                    <img
                      alt="main-logo"
                      class="main-logo"
                      src="/backend_assets/assets/images/logo.png"
                    />
                    <img
                      alt="white-logo"
                      class="d-none white-logo"
                      src="/backend_assets/assets/images/white-logo.png"
                    />
                  </router-link>
                  <div>
                    <button
            ...
            >
              ...
              <li>
                <div class="dropdown mail">
                  ...
                  >
                    ...
                    <div class="notification-menu scroll-bar h-400">
                      <router-link class="dropdown-item py-3" to="/read-email">
                        <small class="float-end text-body ps-2">
                          1 min ago
                        </small>
                        <div class="d-flex align-items-center">
              ...
              <li>
                <div class="dropdown languages">
                  <button
                    aria-expanded="false"
                    class="btn dropdown-toggle border-0 d-flex align-items-center ps-0 pt-0 pb-0"
                    data-bs-toggle="dropdown"
                    type="button"
                  >
                    <img
                      alt="united-states"
                      src="/backend_assets/assets/images/flag/united-states.png"
                    />
                  </button>
                  <ul class="dropdown-menu border-0 box-shadow rounded-0">
                    <li>
                      ...
                      >
                        <img
                          alt="english"
                          src="/backend_assets/assets/images/flag/english.png"
                        />
                    ...
                    <li>
                      ...
                      >
                        <img
                          alt="arabic"
                          src="/backend_assets/assets/images/flag/arabic.png"
                        />
                        <span class="ms-2 text-dark">Arabic</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <img
                          alt="chinal"
                          src="/backend_assets/assets/images/flag/chinal.png"
                        />
                        <span class="ms-2 text-dark">China</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <img
                          alt="spain"
                          src="/backend_assets/assets/images/flag/spain.png"
                        />
                        <span class="ms-2 text-dark">Spain</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        <img
                          alt="russia"
                          src="/backend_assets/assets/images/flag/russia.png"
                        />
                        <span class="ms-2 text-dark">Russia</span>
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  >
                    <div class="flex-shrink-0">
                      <img
                        ...
                        src="/backend_assets/assets/images/user/user-1.jpg"
                      />
                    </div>
